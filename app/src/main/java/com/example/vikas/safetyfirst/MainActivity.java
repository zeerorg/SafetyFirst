...
/*
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_news) {
            ...
            fragmentTransaction.replace(R.id.fragment_container,new NewsFragment()).commit();

        } else if (id == R.id.nav_knowit) {
            FragmentTransaction fragmentTransaction = mFragmentManager.beginTransaction();
            fragmentTransaction.replace(R.id.fragment_container,new KnowitFragment()).commit();
