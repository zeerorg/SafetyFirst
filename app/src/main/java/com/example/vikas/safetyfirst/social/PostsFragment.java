...
import com.example.vikas.safetyfirst.social.Models.Post;
...
public class PostsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.social_fragment_posts, container, false);
        rootView.setTag(TAG);
    ...
    private FirebaseRecyclerAdapter<Post, PostViewHolder> getFirebaseRecyclerAdapter(Query query) {
        return new FirebaseRecyclerAdapter<Post, PostViewHolder>(
                Post.class, R.layout.social_post_item, PostViewHolder.class, query) {
            @Override
