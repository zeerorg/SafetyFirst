...
public class UserProfileFragment extends Fragment {
        ...
        ValueEventListener userListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (user.getDesignation() == null ){
                    ...
                    if (getCurrentUserId().equals(dataSnapshot.getKey())){
               ...
               /* else{
                ...
                mDesignation.setText("Designation: " + user.getDesignation());
                mQualification.setText("Qualification: " + user.getQualification());
                mCompany.setText("Company: " + user.getCompany());
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        profileButton = (Button) mainView.findViewById(R.id.update_profile_button);
        mUserName = (TextView) mainView.findViewById(R.id.user_name);

        //mUserId = getCurrentUserId();
        mUserId = getArguments().getString(USER_ID_EXTRA_NAME);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    followUserFab.setImageDrawable(ContextCompat.getDrawable(
                            getActivity(), R.drawable.ic_done_24dp));
                } else {
                    followUserFab.setImageDrawable(ContextCompat.getDrawable(
                            getActivity(), R.drawable.ic_person_add_24dpd));
                }
            }
