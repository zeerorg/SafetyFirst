package com.vikas.dtu.safetyfirst2.app;
...
import com.vikas.dtu.safetyfirst2.mUtils.NotificationUtils;
...
public class TestActivity extends AppCompatActivity {
    ...
    public void sendNotificationToUser(String user, final String message) {
        ...
        Toast.makeText(TestActivity.this, "Notification sent" , Toast.LENGTH_SHORT).show();
    }
}
