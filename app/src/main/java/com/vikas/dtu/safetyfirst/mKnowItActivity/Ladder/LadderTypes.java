...
public class LadderTypes extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
      ...
      yourText = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. " +
        ...
        trestleLadder = "•	The Trestle Ladder, also known as a Double Front Ladder, is a self-supporting portable ladder that is non-adjustable in length, and hinged at the top. It consists of two sections and is designed to be climbed by two persons at the same time, one on each side.\n"+
        ...
        TextView standardLadderTextView = (TextView) findViewById(R.id.standard_ladder);
        TextView twoWayLadderTextView = (TextView) findViewById(R.id.two_way_ladder);


        TextView orchardLadderTextView = (TextView) findViewById(R.id.orchard_ladder);

        TextView trestleLadderTextView = (TextView)findViewById(R.id.trestle_ladder);

        TextView platformLadderTextView = (TextView)findViewById(R.id.platform_ladder);
    ...
    public void standardLadder(View view){
        ...
        Intent i = new Intent(LadderTypes.this, KnowItDetails.class);
